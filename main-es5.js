...
var AddToCartComponent = /** @class */ (function () {
    function AddToCartComponent(service) {
    ...
    AddToCartComponent.prototype.removeCartProduct = function (product) {
        this.service.removeLocalCartProduct(product);
        // Recalling
        this.getCartProduct();
    };
    AddToCartComponent.prototype.getCartProduct = function () {
...
var CartCalculatorComponent = /** @class */ (function () {
    ...
    CartCalculatorComponent.prototype.ngOnChanges = function (changes) {
        ...
        products.forEach(function (product) {
            _this.totalValue += product.price;
        });
    };
...
var CsrRequestComponent = /** @class */ (function () {
    function CsrRequestComponent(fb) {
        this.fb = fb;
        this.csrFormValueOut = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    CsrRequestComponent.prototype.ngOnInit = function () {
    ...
    CsrRequestComponent.prototype.onCustomerSubmit = function (csrFormValue) {
    ...
    CsrRequestComponent.ctorParameters = function () { return [
...
var HelpComponent = /** @class */ (function () {
    ...
    HelpComponent.prototype.customerService = function () {
        this.targetCsrOut.emit(true);
        console.log('csr', this.targetCsrOut);
    };
    HelpComponent.prototype.technicalSupport = function () {
...
var NavBarComponent = /** @class */ (function () {
    ...
    NavBarComponent.prototype.goToHelp = function () {
        this.redirectTo('help');
    };
    NavBarComponent.prototype.redirectTo = function (uri) {
        var _this = this;
...
var PageNotFoundComponent = /** @class */ (function () {
    ...
    PageNotFoundComponent.prototype.homePage = function () {
...
var ProductInfoComponent = /** @class */ (function () {
    function ProductInfoComponent(route, service, toastrService) {
        this.route = route;
        this.service = service;
    ...
    ProductInfoComponent.prototype.getProductInfo = function (id) {
        var _this = this;
        // this.spinnerService.show();
        var x = this.service.getProductById(id);
    ...
    ProductInfoComponent.prototype.addToCart = function (product) {
        this.service.addToCart(product);
    };
    ProductInfoComponent.prototype.ngOnDestroy = function () {
...
var TsrRequestComponent = /** @class */ (function () {
    function TsrRequestComponent(fb) {
        this.fb = fb;
        this.tsrFormValueOut = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    TsrRequestComponent.prototype.ngOnInit = function () {
    ...
    TsrRequestComponent.prototype.onCustomerSubmit = function (tsrFormValue) {
    ...
    TsrRequestComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
...
var MainAboutUsComponent = /** @class */ (function () {
    function MainAboutUsComponent() {
    }
    MainAboutUsComponent.prototype.ngOnInit = function () {
    };
...
var MainHelpComponent = /** @class */ (function () {
    function MainHelpComponent(customerService, toastr) {
    ...
    MainHelpComponent.prototype.tsrFormValueIn = function (tsrFormValue) {
    ...
    MainHelpComponent.prototype.csrFormValueIn = function (csrFormValue) {
    ...
    MainHelpComponent.prototype.tsrTargetIn = function (tsr) {
        this.targetHelp = false;
        this.targetTsr = tsr;
        this.targetCsr = false;
    };
    MainHelpComponent.prototype.csrTargetIn = function (csr) {
        this.targetHelp = false;
        this.targetTsr = false;
        this.targetCsr = csr;
    };
    MainHelpComponent.ctorParameters = function () { return [
...
var PosAppRoutingModule = /** @class */ (function () {
    function PosAppRoutingModule() {
    }
...
var PosAppModule = /** @class */ (function () {
    function PosAppModule() {
    }
...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(fb, toastr) {
        this.fb = fb;
        this.toastr = toastr;
    ...
    AddProductComponent.prototype.showPreview = function (event) {
        var _this = this;
    ...
    AddProductComponent.prototype.onSubmit = function (formValue) {
    ...
    Object.defineProperty(AddProductComponent.prototype, "formControls", {
        get: function () {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.signIn = function () {
        ...
        this.authService.login({
            ...
            _this.router.navigate(['/user/admin/home-admin']);
        }, function (err) {
            console.log(err);
            // alert(err);
...
var ProductDetailsComponent = /** @class */ (function () {
    function ProductDetailsComponent(service, fb) {
        this.service = service;
        this.fb = fb;
        this.selectedImage = null;
        this.searchText = '';
    ...
    // DELETE FUNCTION
    ProductDetailsComponent.prototype.onDelete = function ($key, downloadUrl) {
        var _this = this;
    ...
    ProductDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.service.getImageDetailList().subscribe(function (list) {
            _this.imageArray = list.map(function (item) {
    ...
    Object.defineProperty(ProductDetailsComponent.prototype, "formControls", {
        get: function () {
            return this.formTemplate.controls;
        },
        enumerable: true,
    ...
    ProductDetailsComponent.prototype.populateForm = function (populate) {
        this.formTemplate.setValue(populate);
    };
    ProductDetailsComponent.prototype.filterCondition = function (image) {
        return image.prodName.toLowerCase().indexOf(this.searchText.toLowerCase()) !== -1;
    };
    // EDIT FUNCTION
    // EDIT WILL NOT WORK WITHOUT THIS
    ProductDetailsComponent.prototype.onImageUpdate = function (image) {
    ...
    ProductDetailsComponent.prototype.onSave = function () {
        var _this = this;
        this.isSubmitted = true;
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(service, fb, toastr) {
        this.service = service;
        this.fb = fb;
        this.toastr = toastr;
    ...
    ProductListComponent.prototype.ngOnInit = function () {
        var _this = this;
        var x = this.service.getImageDetailList();
    ...
    // Search per product
    ProductListComponent.prototype.filterAsus = function (product) {
        return product.category.toLowerCase().indexOf(this.searchAsus.toLowerCase()) !== -1;
    };
    ProductListComponent.prototype.filterSamsung = function (product) {
        return product.category.toLowerCase().indexOf(this.searchSamsung.toLowerCase()) !== -1;
    };
    ProductListComponent.prototype.filterHuawei = function (product) {
        return product.category.toLowerCase().indexOf(this.searchHuawei.toLowerCase()) !== -1;
    };
    ProductListComponent.prototype.filterOppo = function (product) {
        return product.category.toLowerCase().indexOf(this.searchOppo.toLowerCase()) !== -1;
    };
    ProductListComponent.prototype.filterIphone = function (product) {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegistrationSubmit = function (regFormValue) {
...
var MainRegisterComponent = /** @class */ (function () {
    function MainRegisterComponent(authService, toastr, adduser) {
        this.authService = authService;
        this.toastr = toastr;
        this.adduser = adduser;
    }
    MainRegisterComponent.prototype.ngOnInit = function () {
    };
    MainRegisterComponent.prototype.regFormValueIn = function (regFormValue) {
        var _this = this;
        ...
        this.authService.register({
            ...
            _this.adduser.insertUserDetails(regFormValue);
            _this.toastr.success('You have been successfully registered!');
            console.log(result.user);
        }).catch(function (error) {
            _this.toastr.success(error.message);
        });
    };
    MainRegisterComponent.ctorParameters = function () { return [
...
var UserComponent = /** @class */ (function () {
    function UserComponent(storage, service, router, authService, toastr) {
    ...
    UserComponent.prototype.navigateHome = function () {
        this.router.navigateByUrl('user/admin/home-admin');
    };
    UserComponent.prototype.navigateInventory = function () {
        this.router.navigateByUrl('user/admin/product-details');
    };
    UserComponent.prototype.navigateMyProducts = function () {
        this.router.navigateByUrl('user/admin/product-list');
    };
    UserComponent.prototype.navigateCreateUser = function () {
        this.router.navigateByUrl('user/admin/register-employee');
    };
    UserComponent.prototype.formValueIn = function (formValue) {
        var _this = this;
        console.log(formValue);
        var filePath = formValue.category + "/" + formValue.selectImage.name.split('.').slice(0, -1).join('.') + "_" + new Date().getTime();
        var fileRef = this.storage.ref(filePath);
        this.storage.upload(filePath, formValue.selectImage).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () {
...
var PosUserRoutingModule = /** @class */ (function () {
    function PosUserRoutingModule() {
    }
...
var PosUserModule = /** @class */ (function () {
    function PosUserModule() {
    }
...
var AddUserService = /** @class */ (function () {
    function AddUserService(firebase, fireStorage) {
        this.firebase = firebase;
        this.fireStorage = fireStorage;
        this.userDetailList = firebase.list('usersList');
    }
    AddUserService.prototype.insertUserDetails = function (userList) {
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.register = function (reg) {
...
var AddingProductsService = /** @class */ (function () {
    function AddingProductsService(firebase, fireStorage, toastrService) {
        this.firebase = firebase;
        this.fireStorage = fireStorage;
        this.toastrService = toastrService;
    ...
    AddingProductsService.prototype.addToCart = function (data) {
        var a;
    ...
    AddingProductsService.prototype.removeLocalCartProduct = function (product) {
    ...
    AddingProductsService.prototype.getLocalCartProducts = function () {
        var products = JSON.parse(localStorage.getItem('avct_item')) || [];
        return products;
    };
    // returning LocalCarts Product Count
    AddingProductsService.prototype.calculateLocalCartProdCounts = function () {
        this.navbarCartCount = this.getLocalCartProducts().length;
    };
    AddingProductsService.prototype.getProductById = function (key) {
        this.product = this.firebase.object('imageDetails/' + key);
        return this.product;
    };
    AddingProductsService.prototype.getImageDetailList = function () {
        this.imageDetailList = this.firebase.list('imageDetails');
        return this.imageDetailList.snapshotChanges();
    };
    AddingProductsService.prototype.insertImageDetails = function (imageDetails) {
        this.imageDetailList.push(imageDetails);
    };
    AddingProductsService.prototype.deleteDataImage = function ($key) {
        this.imageDetailList.remove($key);
    };
    AddingProductsService.prototype.deleteImage = function (downloadUrl) {
        return this.fireStorage.storage.refFromURL(downloadUrl).delete();
    };
    AddingProductsService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] },
        { type: _angular_fire_storage__WEBPACK_IMPORTED_MODULE_3__["AngularFireStorage"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"] }
    ]; };
...
var CustomerService = /** @class */ (function () {
    function CustomerService(firebase, fireStorage) {
        this.firebase = firebase;
        this.fireStorage = fireStorage;
        this.tsrDetailList = firebase.list('tsrList');
        this.csrDetailList = firebase.list('csrList');
    }
    CustomerService.prototype.getTsrDetailList = function () {
        this.tsrDetailList = this.firebase.list('tsrList');
        return this.tsrDetailList.snapshotChanges();
    };
    CustomerService.prototype.getCsrDetailList = function () {
        this.tsrDetailList = this.firebase.list('csrList');
        return this.tsrDetailList.snapshotChanges();
    };
    CustomerService.prototype.insertTsrDetails = function (tsrList) {
        this.tsrDetailList.push(tsrList);
    };
    CustomerService.prototype.insertCsrDetails = function (csrList) {
